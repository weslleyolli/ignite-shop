...
export default function Index() {
    ...
    const aClasses = 'keen-slider__slide bg-gradient-to-b from-teal-400 via-teal-500 to-indigo-500 rounded-lg cursor-pointer relative flex items-center justify-center object-cover'

    return (
        <div className="flex flex-col items-start justify-center min-h-screen gap-6" >
            <Header />
            <main ref={sliderRef} className='keen-slider flex w-full max-w-[calc(100vw-((100vw-1180px)/2))] ml-auto min-h-[656px] ' >
